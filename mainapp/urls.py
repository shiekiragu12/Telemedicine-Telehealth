...
urlpatterns = [
    ...
    path("medical-practitioner/", medical_practitioners, name="medical_practitioners"),
    path("medical-practitioner/search/", doctor_search, name="doctor_search"),
    path("medical-practitioner/view/<str:doctor_id>/", single_doctor, name="single-doctor"),
